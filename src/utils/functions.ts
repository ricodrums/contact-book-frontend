...
export const getAvatar = (val1: string, val2?: string) => `${val1.charAt(0).toUpperCase()}${val2 ? val2.charAt(0).toUpperCase() : ''}`
export const formatDate = (val: string) => val ? val.replaceAll('/', '-') : ''
